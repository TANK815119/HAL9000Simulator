...
namespace Rekabsen
{
    public class HandAnimationNetwork : NetworkBehaviour, HandAnimationInterface
    {
        ...
        [SerializeField] public GrabPose Pose { get; set; } //rename GrabPose enum
        ...
        void Update()
        {
            ...
            if (Gripping)
            {
                switch (Pose)
                {
                    case GrabPose.Plane: FlatGrip(); break;
                    case GrabPose.Corner: CornerGrip(); break;
                    case GrabPose.Sphere: SphereGrip(); break;
                    case GrabPose.Cylinder: CylinderGrip(); break;
